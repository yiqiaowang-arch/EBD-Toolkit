...
public class ProcessWalkthroughCustomEditor : Editor
{
    ...
    private void FileIO()
    {
        ...
        GUILayout.Label(CustomEditorUtils.GetPathFromProjectRoot(processor.rawDataDirectory));
        ...
        GUILayout.TextField(CustomEditorUtils.GetPathFromProjectRoot(processor.outProcessedDataFileName));

        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel("Summarized data file name:");
        GUILayout.TextField(CustomEditorUtils.GetPathFromProjectRoot(processor.outSummarizedDataFileName));
